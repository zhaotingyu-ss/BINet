...
parser.add_argument('--data_dir', metavar='DIR', default='./BINet/data/nyu_preprocess_tst', help='path to images folder')
parser.add_argument('--pretrained', metavar='PTH', help='path to pre-trained model', default= './model_best.tar')
parser.add_argument('--output', metavar='DIR', default= './output_nyu/' , help='path to output folder')
...
def main():
    ...
    for scale in [0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1,]:
        ...
        n_spixel = int(input_img_height/16 * scale * input_img_width /16 * scale)
